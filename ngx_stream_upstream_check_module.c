...
static ngx_buf_t *ngx_stream_upstream_check_create_fastcgi_request(
...
static ngx_int_t ngx_stream_upstream_check_ssl_hello_init(
    ngx_stream_upstream_check_peer_t *peer);
static ngx_int_t ngx_stream_upstream_check_ssl_hello_parse(
    ngx_stream_upstream_check_peer_t *peer);
...
static ngx_int_t ngx_stream_upstream_check_ajp_init(
    ngx_stream_upstream_check_peer_t *peer);
static ngx_int_t ngx_stream_upstream_check_ajp_parse(
    ngx_stream_upstream_check_peer_t *peer);
static void ngx_stream_upstream_check_ajp_reinit(
    ngx_stream_upstream_check_peer_t *peer);
...
static char *ngx_stream_upstream_check_fastcgi_params(ngx_conf_t *cf,
    ngx_command_t *cmd, void *conf);
...
static ngx_command_t  ngx_stream_upstream_check_commands[] = {
    ...
    { ngx_string("check_fastcgi_param"),
      ...
      ngx_stream_upstream_check_fastcgi_params,
      0,
      0,
      NULL },
...
#define NGX_SSL_RANDOM "NGX_STREAM_CHECK_SSL_HELLO\n\n\n\n"
...
static ngx_check_conf_t  ngx_check_types[] = {
    ...
    { NGX_STREAM_CHECK_HTTP,
      ...
      ngx_stream_upstream_check_recv_handler,
      ngx_stream_upstream_check_http_init,
      ngx_stream_upstream_check_fastcgi_parse,
      ngx_stream_upstream_check_http_reinit,
      1,
      0 },
    ...
    { NGX_STREAM_CHECK_AJP,
      ngx_string("ajp"),
      ngx_string(ngx_ajp_cping_packet),
      0,
      ngx_stream_upstream_check_send_handler,
      ngx_stream_upstream_check_recv_handler,
      ngx_stream_upstream_check_ajp_init,
      ngx_stream_upstream_check_ajp_parse,
      ngx_stream_upstream_check_ajp_reinit,
      1,
      0 },
...
static ngx_int_t
ngx_stream_upstream_check_fastcgi_parse(ngx_stream_upstream_check_peer_t *peer)
{
    ngx_int_t                            rc;
    ngx_flag_t                           done;
    ...
    for ( ;; ) {
        ...
        for ( ;; ) {
            rc = ngx_stream_upstream_check_parse_fastcgi_status(ctx,
                                                              &ctx->recv,
                                                              &ctx->status);
...
static ngx_int_t
ngx_stream_upstream_check_parse_fastcgi_status(ngx_stream_upstream_check_ctx_t *ctx,
...
static ngx_int_t
ngx_stream_upstream_check_ssl_hello_init(ngx_stream_upstream_check_peer_t *peer)
{
    ngx_stream_upstream_check_ctx_t       *ctx;
    ngx_stream_upstream_check_srv_conf_t  *ucscf;
...
static ngx_int_t
ngx_stream_upstream_check_ssl_hello_parse(ngx_stream_upstream_check_peer_t *peer)
{
    size_t                         size;
...
static void
ngx_stream_upstream_check_ssl_hello_reinit(ngx_stream_upstream_check_peer_t *peer)
{
    ngx_stream_upstream_check_ctx_t *ctx;
...
static ngx_int_t
ngx_stream_upstream_check_mysql_init(ngx_stream_upstream_check_peer_t *peer)
{
    ngx_stream_upstream_check_ctx_t       *ctx;
    ngx_stream_upstream_check_srv_conf_t  *ucscf;
...
static void
ngx_stream_upstream_check_mysql_reinit(ngx_stream_upstream_check_peer_t *peer)
{
    ngx_stream_upstream_check_ctx_t *ctx;
...
static ngx_int_t
ngx_stream_upstream_check_ajp_init(ngx_stream_upstream_check_peer_t *peer)
{
    ngx_stream_upstream_check_ctx_t       *ctx;
    ngx_stream_upstream_check_srv_conf_t  *ucscf;
...
static ngx_int_t
ngx_stream_upstream_check_ajp_parse(ngx_stream_upstream_check_peer_t *peer)
{
    size_t                         size;
    u_char                        *p;
    ngx_stream_upstream_check_ctx_t *ctx;
...
static void
ngx_stream_upstream_check_ajp_reinit(ngx_stream_upstream_check_peer_t *peer)
{
    ngx_stream_upstream_check_ctx_t  *ctx;
...
{
    ngx_conf_log_error(NGX_LOG_DEBUG_STREAM, cf, 0,
		    "*******************check stanza found**************************");
    ngx_str_t                           *value, s;
...
static char *
ngx_stream_upstream_check_fastcgi_params(ngx_conf_t *cf, ngx_command_t *cmd,
    void *conf)
{
    ngx_str_t                           *value, *k, *v;
    ngx_stream_upstream_check_srv_conf_t  *ucscf;
...
static ngx_buf_t *
ngx_stream_upstream_check_create_fastcgi_request(ngx_pool_t *pool,
...
ngx_stream_upstream_check_init_main_conf(ngx_conf_t *cf, void *conf)
{
    ...
    b = ngx_stream_upstream_check_create_fastcgi_request(cf->pool,
...
ngx_stream_upstream_check_init_srv_conf(ngx_conf_t *cf, void *conf)
{
    ...
    if (check) {
        if (ucscf->send.len == 0) {
            ...
            if (check == ngx_stream_get_check_type_conf(&s)) {
                ...
                if (ucscf->fastcgi_params->nelts == 0) {
                    ...
                    b = ngx_stream_upstream_check_create_fastcgi_request(
